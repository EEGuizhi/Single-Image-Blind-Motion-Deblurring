# BSChen
# 接下來在這邊跑原本 Repo 的 model 測試

PATH_DATASET    = "/home/bschen/deep_learning/final_project/datasets/RSBlur/"
PATH_CHECKPOINT = "/home/bschen/deep_learning/final_project/pretrain_weights/realblur_j-width32.pth"
WIDTH = 32
...
from original_github_repo.MLWNet.basicsr.data.data_util import paired_paths_from_lmdb
from original_github_repo.MLWNet.basicsr.models.archs.MLWNet_arch import MLWNet_Local
from original_github_repo.MLWNet.basicsr.metrics.psnr_ssim import PSNR, SSIM
...
def pre_val(opt):
    ...
    model = MLWNet_Local(dim=WIDTH, base_size=base_size)
    f.write(f'{base_size}')
    use_gpu = False
    if opt.device == 'GPU':
        use_gpu = True
...
if __name__ == '__main__':
    ...
    parse.add_argument('--weights', type=str, default=PATH_CHECKPOINT, help='pretrained weights')
    parse.add_argument('--cfg', type=str, default="fptd")
    parse.add_argument('--dir', type=str, default='/mnt/d/realblur/RealBlur_J/test/')
